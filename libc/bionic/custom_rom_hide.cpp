...
static const char* const kProcFilterKeywords[] = {
    "lineage", "Lineage", "infinity", "Infinity-X", "ProjectInfinityX", "omnirom",
    "aospa",
    nullptr
};
...
static const char* const kVintfFilterKeywords[] = {
    "lineage", "Lineage", "infinity", "Infinity-X", "ProjectInfinityX", nullptr
};
...
static const char* const kSpoofedEmptyProps[] = {
    "ro.infinity.version", "ro.lineage.version", "ro.lineage.build.version", "ro.cm.build.version",
